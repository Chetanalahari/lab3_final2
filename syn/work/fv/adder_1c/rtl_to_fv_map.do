...
# Generated on: Thu Feb 02 20:10:54 PST 2023 (Fri Feb 03 04:10:54 GMT 2023)
...
set_log_file fv/adder_1c/rtl_to_fv_map.log -replace

usage -auto -elapse

set_verification_information rtl_fv_map_db

read_implementation_information fv/adder_1c -revised fv_map
...
read_design -enumconstraint -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -sv09  ../rtl/adder_1c.sv
elaborate_design -golden -root {adder_1c} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/adder_1c/fv_map.v.gz
elaborate_design -revised -root {adder_1c}
...
if {$lec_version >= $lec_version_required} {
    analyze_results -logfiles fv/adder_1c/rtl_to_fv_map.log
}
